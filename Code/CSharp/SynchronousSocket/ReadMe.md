...
This project was intended to demonstrate capabilities in C# and object-oriented programming with a simple example synchronous socket communication example. This project also provided me with an opportunity to practice with socket programming and master-slave communications. Initially I had big plans for this project but I had to scale back to an “MVP” (Minimal Viable Product) approach. This example mirrors aspects of [Modbus](https://product-help.schneider-electric.com/ED/ES_Power/NT-NW_Modbus_IEC_Guide/EDMS/DOCA0054EN/DOCA0054xx/Master_NS_Modbus_Protocol/Master_NS_Modbus_Protocol-2.htm) and the description below will compare and contrast it to Modbus. Wikipedia describes Modbus as follows:
...
For simplicity, the server generates random data between 0 and 100 for all data producers(sensors). Originally, I had considered coding functions to generate data that more closely resembles device/sensor output for liquids and gas pipelines but I will leave this as a future to-do… for now 😊
