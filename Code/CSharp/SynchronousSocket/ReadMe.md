...
For simplicity, the server generates random data between 0 and 100 for all data producers(sensors). Additional functions could be added to generate data that more closely resembles device/sensor output for liquids and gas pipelines. 😊
